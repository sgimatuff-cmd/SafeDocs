...
<body class="d-flex flex-column min-vh-100">
        ...
        <div class="container">
            ...
            <div class="ms-auto d-flex gap-2">
                ...
                @else
                    ...
                    <a href="{{ route('register') }}" class="btn btn-light btn-sm fw-semibold">Registar</a>
                @endauth
            </div>
        </div>
    </nav>
    ...
    <section class="hero">
        <div class="container">
            <h1>SafeDocs.</h1>
            <p class="mt-3 mb-4">
                Guardamos os documentos da sua empresa de forma segura e organizada. Simples assim.
            </p>
            @auth
                <a href="{{ route('dashboard') }}" class="btn btn-light fw-semibold px-4">
                    <i class="bi bi-speedometer2 me-2"></i>Dashboard
                </a>
            @else
                <div class="d-flex gap-3">
                    <a href="{{ route('login') }}" class="btn btn-light fw-semibold px-4">Entrar</a>
                    <a href="{{ route('register') }}" class="btn btn-outline-light px-4">Criar conta</a>
                </div>
            @endauth
        </div>
    </section>
    ...
    <section class="py-5" style="background:#f9f9f9">
        <div class="container">
            <div class="row g-4">
                <div class="col-md-4">
                    <p class="fw-semibold mb-1">Acesso controlado</p>
                    <p class="text-muted mb-0" style="font-size:.88rem;line-height:1.7">Cada colaborador acede apenas ao que lhe diz respeito. O administrador define as permissões.</p>
                </div>
                <div class="col-md-4">
                    <p class="fw-semibold mb-1">Tudo registado</p>
                    <p class="text-muted mb-0" style="font-size:.88rem;line-height:1.7">Quem abriu, quem descarregou e quando. O historial de cada documento está sempre disponível.</p>
                </div>
                <div class="col-md-4">
                    <p class="fw-semibold mb-1">Sem complicações</p>
                    <p class="text-muted mb-0" style="font-size:.88rem;line-height:1.7">Upload direto, sem passos intermédios. A plataforma trata do resto.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-5 mt-auto" style="background:var(--preto);color:#fff">
        <div class="container d-flex justify-content-between align-items-center flex-wrap gap-3">
            ...
            <div class="d-flex gap-2">
                <a href="{{ route('login') }}" class="btn btn-light fw-semibold px-4">Entrar</a>
                <a href="{{ route('register') }}" class="btn btn-outline-light px-4">Registar</a>
            </div>
        </div>
    </section>
