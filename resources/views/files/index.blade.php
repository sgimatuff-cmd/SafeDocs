...
<div class="d-flex align-items-center justify-content-between mb-4">
    ...
    <a href="{{ route('ficheiros.create') }}" class="btn btn-primary btn-sm">
...
{{-- Pesquisa e filtro --}}
<form method="GET" action="{{ route('ficheiros.index') }}" class="mb-4">
    <div class="d-flex flex-wrap gap-2 align-items-center">
        ...
        @if($pesquisa || $grupoFiltro)
            <a href="{{ route('ficheiros.index') }}" class="btn btn-outline-danger btn-sm">
                    ...
                    <tr class="{{ $f->estaExpirado() ? 'table-secondary' : '' }}">
                        ...
                        <td class="text-end">
                            <div class="d-flex gap-1 justify-content-end">
                                @if(!$f->estaExpirado())
                                <a href="{{ route('ficheiros.download', $f) }}"
                                ...
                                <form method="POST" action="{{ route('ficheiros.destroy', $f) }}"
