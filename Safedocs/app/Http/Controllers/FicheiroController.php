...
class FicheiroController extends Controller
{
    public function listar(Request $request)
    {
        ...
        return view('ficheiros.listar', compact('ficheiros', 'pesquisa', 'grupos', 'grupoFiltro'));
    }
    ...
    public function criar()
    {
        ...
        return view('ficheiros.criar', compact('grupos'));
    }
    ...
    public function guardar(Request $request)
    {
        ...
        return redirect()->route('ficheiros.listar')
            ->with('success', 'Ficheiro carregado com sucesso!');
    }

    public function descarregar(Ficheiro $ficheiro)
    {
        $utilizador = Auth::user();
    ...
    public function eliminar(Ficheiro $ficheiro)
    {
        $utilizador = Auth::user();

        if (!$utilizador->eAdmin() && !$utilizador->grupos->contains($ficheiro->grupo_id)) {
            return back()->with('error', 'Não tens permissão para eliminar este ficheiro.');
        }
