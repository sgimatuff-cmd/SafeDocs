...
<div class="card border-0 shadow-sm" style="max-width:560px">
    <div class="card-body p-4">
        <form method="POST" action="{{ route('ficheiros.guardar') }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="d-flex gap-2">
                ...
                <a href="{{ route('ficheiros.listar') }}" class="btn btn-outline-secondary btn-sm">Cancelar</a>
            </div>
        </form>
    </div>
</div>
