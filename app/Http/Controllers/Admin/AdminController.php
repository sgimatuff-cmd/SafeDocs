...
class AdminController extends Controller
{
    ...
    {
        $utilizadores = User::withCount('ficheiros')
            ->with(['grupos', 'cargos'])
            ->latest()
            ->paginate(20);
        ...
        return view('admin.utilizadores', compact('utilizadores', 'cargos'));
    }

    public function promover(Request $request, User $utilizador)
    {
        $request->validate([
    ...
    public function eliminar(User $utilizador)
    {
    ...
    public function adicionarAoGrupo(Request $request, User $utilizador)
    {
        $request->validate([
    ...
    public function removerDoGrupo(Request $request, User $utilizador, Grupo $grupo)
    {
    ...
    public function adicionarCargo(Request $request, User $utilizador)
    {
        $request->validate([
    ...
    public function removerCargo(User $utilizador, Cargo $cargo)
    {
